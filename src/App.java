...
public class App {
    ...
    private static double getExchangeRate(String fromCurrency, String toCurrency) {
        String apiUrl = "https://v6.exchangerate-api.com/v6/62fd85224b074f2424eb157b/pair/" + fromCurrency + "/" + toCurrency;
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                System.out.println("Error: no se pudo obtener una respuesta válida. Código de respuesta: " + responseCode);
            }
        } catch (Exception e) {
